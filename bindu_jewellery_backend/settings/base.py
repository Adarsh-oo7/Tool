...
# BASE_DIR now points 3 levels up → project root (where manage.py is)
BASE_DIR = Path(__file__).resolve().parent.parent.parent

SECRET_KEY = config("DJANGO_SECRET_KEY", default="django-insecure-q$vo4=-fh$&+$yv@%e!=bvn14%gtcm6)w#m)195l5@rm(y=u6o")
...
ROOT_URLCONF = "bindu_jewellery_backend.urls"
WSGI_APPLICATION = "bindu_jewellery_backend.wsgi.application"
ASGI_APPLICATION = "bindu_jewellery_backend.asgi.application"
...
AWS_STORAGE_BUCKET_NAME = config("AWS_STORAGE_BUCKET_NAME", default="bindu-media")
...
# Gemini (kept as legacy fallback — no longer primary)
