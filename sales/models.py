...
class Sale(models.Model):
    ...
    branch   = models.ForeignKey('branches.Branch', on_delete=models.SET_NULL,   # ← SET_NULL
                                  null=True, blank=True, related_name='sales')    # ← null+blank
    ...
    sale_type      = models.CharField(max_length=20, choices=SALE_TYPES, default='normal')
    ...
    def __str__(self):
        return f'Sale {self.weight_grams}g — {self.product_name} @ {self.branch}'